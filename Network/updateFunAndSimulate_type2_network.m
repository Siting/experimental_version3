function[LINK, SOURCE_LINK, SINK_LINK, JUNCTION, T, deltaTinSecond, thresholdVector] = updateFunAndSimulate_type2_network(POPULATION_2, LINK, SOURCE_LINK, SINK_LINK, JUNCTION,...
